package com.hql.functions.pagination.persistent.dto;
...
@Entity
@Table(name = "employee_hql_functions_pagination_mstr")
public class EmployeePersistentDTO {
	...
	@TableGenerator(
			...
			table = "EMPLOYEEID_HQL_FUNCTIONS_PAGINATION_GENERATOR",
			pkColumnName = "myid",
