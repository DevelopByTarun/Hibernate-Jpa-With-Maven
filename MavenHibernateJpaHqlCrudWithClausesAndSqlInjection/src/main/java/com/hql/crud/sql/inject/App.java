...
public class App 
{
	...
	public static void main( String[] args ) {
    	...
    	while(true) {
    		...
    		System.out.println("7. Sort Employee Records Order By");
    		System.out.println("8. Sort Employee Records Group By");
    		...
    		if(choice == 1) {
    			...
    			int status = 0;
    			status = EmployeeDAO.updateEmployee(name, salary, id);
    			if(status > 0) {
    			...
    			ArrayList<EmployeePersistentDTO> empList = EmployeeDAO.sortEmployeesOrderBy();
    			if(empList != null && empList.size() > 0) {
    				for(EmployeePersistentDTO empOB: empList) {
    			...
    			List<Object[]> empList = EmployeeDAO.sortEmployeesGroupBy();
    			if(empList != null && empList.size() > 0) {
    				for(int i = 0; i < empList.size(); i++) {
    					Object[] data = empList.get(i);
    					System.out.println("Employee Salary Is :: "+data[0]);
    					System.out.println("Employee Name Is :: "+data[1]);
    					System.out.println("");
    				}
    			}
    			else {
