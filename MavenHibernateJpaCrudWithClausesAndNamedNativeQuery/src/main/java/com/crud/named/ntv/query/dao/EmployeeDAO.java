package com.crud.named.ntv.query.dao;
...
import com.crud.named.ntv.query.connection.HibernateUtil;
...
public class EmployeeDAO {
	...
	public static int updateEmployee(EmployeePersistentDTO epDTO) {
		...
		try {
			tx = session.beginTransaction();
			Query query = session.getNamedNativeQuery("forUpdate");
	...
	public static int deleteEmployee(int id) {
		...
		try {
			tx = session.beginTransaction();
			Query query = session.getNamedNativeQuery("forDelete");
	...
	public static ArrayList<EmployeePersistentDTO> getAllEmployees() {
		...
		session = HibernateUtil.getSessionFactory().openSession();
		try {
			Query query = session.getNamedNativeQuery("forSelectAll");
	...
	public static EmployeePersistentDTO getEmployeeById(int id) {
		...
		session = HibernateUtil.getSessionFactory().openSession();
		try {
			Query query = session.getNamedNativeQuery("forEmployeeById");
			query.setParameter("id", id);
	...
	public static ArrayList<EmployeePersistentDTO> sortEmployeesByGTESalaries(double amount) {
		...
		session = HibernateUtil.getSessionFactory().openSession();
		try {
			Query query = session.getNamedNativeQuery("forSorting");
